        ...
        <section className="py-20 bg-dental-alt text-center">
          <div className="max-w-3xl mx-auto px-4">
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45 }}>
              <span className="section-label mb-5">Our Services</span>
            </motion.div>
            <motion.h1
            ...
            >
              ...
              <span className="gradient-text">Gulshan-1, Dhaka</span>
            </motion.h1>
            <motion.p
            ...
            >
              From advanced prosthodontic restorations to essential dental care — every service at Faisal&apos;s Dental Care is delivered with specialist precision by Dr. Faisal, FICD Fellow with 28 years of experience.
            </motion.p>
            <motion.p
              initial={{ opacity: 0, y: 12 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.45, delay: 0.3 }}
              className="text-dental-blue text-sm font-semibold mt-4"
            >
              Click any service to see full details, pricing &amp; cost calculator →
            </motion.p>
          </div>
        </section>
